...
from swagger_server.models.day_offer_matrix import DayOfferMatrix  # noqa: F401,E501
...
class DayOfferMatrixEuroMWh(Model):
    ...
    """
    def __init__(self, values: DayOfferMatrix=None, price_unit: str=None, volume_unit: str=None):  # noqa: E501
        """DayOfferMatrixEuroMWh - a model defined in Swagger

        :param values: The values of this DayOfferMatrixEuroMWh.  # noqa: E501
        :type values: DayOfferMatrix
    ...
    @property
    def values(self) -> DayOfferMatrix:
    ...
    @values.setter
    def values(self, values: DayOfferMatrix):
