...
class StackedRevenuesResult(Model):
    ...
    """
    def __init__(self, sdate: date=None, flex_offer: List[StackedRevenuesResultFlexOffer]=None, revenues: StackedRevenuesResultRevenues=None):  # noqa: E501
    ...
    @property
    def flex_offer(self) -> List[StackedRevenuesResultFlexOffer]:
        """Gets the flex_offer of this StackedRevenuesResult.


        :return: The flex_offer of this StackedRevenuesResult.
        :rtype: List[StackedRevenuesResultFlexOffer]
        """
        return self._flex_offer

    @flex_offer.setter
    def flex_offer(self, flex_offer: List[StackedRevenuesResultFlexOffer]):
